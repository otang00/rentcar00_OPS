...
## 현재 active 작업
**b43 IMS 가져오기 UI/API 배포 완료 / 실기기 확인 대기 + 홈페이지 예약 이벤트 운영 반영 대기**
...
- 앱 버전/build: `1.0.0+43`
- 최신 APK 파일명 기준: `rentcar00_ops-app-release-arm64-b43-851f5fc.apk`
- 작업트리에는 b43 관련 구현/문서 변경이 아직 uncommitted 상태로 남아 있다.
...
3. 현재 작업트리에 uncommitted 변경이 많으므로, 커밋 전 diff 재확인이 필요하다.
4. b43 실기기 확인 전까지는 배포 완료가 아니라 배포물 준비/업로드 완료 상태로 본다.

...
create table if not exists public.rc00_ops_reservations (
  ...
  status_raw text,
  source_sync_run_id uuid references public.rc00_ops_sheet_sync_runs(id) on delete set null,
  source_reservation_raw_id uuid references public.rc00_ops_sheet_reservations_raw(id) on delete set null,
  primary_schedule_raw_id uuid references public.rc00_ops_sheet_schedules_raw(id) on delete set null,
